...
// üîπ 1) Responder "Rawr" si alguien dice "Cami"
client.on("messageCreate", message => {
  if (message.author.bot) return;

  if (message.content.toLowerCase().includes("rawr")) {
    message.channel.send("Rawr ü¶ñ");
  }
  ...
  if (seCaen) {
    message.channel.send(`ü§π Hice malabares con ${pelotas} pelotas y se me cayeron`);
  } else {
    message.channel.send(`ü§π Hice malabares con ${pelotas} pelotas`);
  }
}
...
if (message.content.toLowerCase().includes("pinned")) {
  ...
  if (message.content.toLowerCase().includes("agua")) {
    message.channel.send(`üíß Tomen agua`);
  }
  ...
  if (message.content.toLowerCase().includes("jotape")) {
    message.channel.send(`üçÜ Te parecen bien 47 cm?`);
  }
...
if (
  ...
  ? `üßº Te toc®Æ sabor **jab®Æn**`
    : `üçì Te toc®Æ sabor **frutilla**`;
} else {
  ...
  if (bueno) {
    ...
    if (username === 'nootnoot9070' && Math.random() < 0.02) {
      resultado = `üçë Te toc®Æ sabor **kako**`;
    } else {
      resultado = `üçì Te toc®Æ sabor **frutilla**`;
    }
  } else {
    resultado = `üßº Te toc®Æ sabor **jab®Æn**`;
  }
}
...
if (message.content.toLowerCase().startsWith("!despeinar")) {
    ...
    if (!usuario) {
      return message.reply("ten®¶s que mencionar a alguien gato, a quien vas a despeinar? al aire?");
    }
    ...
    message.channel.send({
      content: `${message.author} despein®Æ a ${usuario}`,
      files: [img]
    });
  }
 ...
 if (message.content.toLowerCase().includes("habil")) {
  ...
  if (message.content.toLowerCase().includes("kentucky")) {
    message.channel.send(`üçï Detonar Kentucky de Av. Santa Fe`);
  }
